...
// TODO: correct the following files
...
public:
	...
	field_type(_field_type), solar_scene(_solar_scene), gl(_gl){}
...
protected:
	...
	__device__ __host__ void calcIntersection3DDDA(Heliostat* helio, const Vector3d&dir, int*& esimate_grid);
	__device__ __host__ void _helio_calc(int index);
