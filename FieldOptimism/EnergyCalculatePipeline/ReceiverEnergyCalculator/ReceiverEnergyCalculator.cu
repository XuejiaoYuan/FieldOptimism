...
void ReceiverEnergyCalculator::calcRecvEnergySum(float * d_total_energy)
{
...
void ReceiverEnergyCalculator::calcRectRecvEnergySum(float * d_total_energy)
{
...
void ReceiverEnergyCalculator::calcCylinderRecvEnergySum(float * d_total_energy)
{
	int helioNum = solar_scene->helios.size();
