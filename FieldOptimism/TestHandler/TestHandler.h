...
public:
	...
	void initSolarScene(string scene_file_path, string sunray_filepath, string output_filepath);
	void createSolarScene(string scene_filepath, string output_filepath);
	void testSunRay();
	...
	void testHelioFluxDensityModel(int M, int N, int m, int n);
