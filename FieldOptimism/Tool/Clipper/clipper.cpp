...
void SwapIntersectNodes(IntersectNode &int1, IntersectNode &Vector2i)
{
  //just swap the contents (because fIntersectNodes is a single-linked-list)
  IntersectNode inode = int1; //gets a copy of Int1
  int1.Edge1 = Vector2i.Edge1;
  int1.Edge2 = Vector2i.Edge2;
  int1.Pt = Vector2i.Pt;
  Vector2i.Edge1 = inode.Edge1;
  Vector2i.Edge2 = inode.Edge2;
  Vector2i.Pt = inode.Pt;
}
//------------------------------------------------------------------------------
